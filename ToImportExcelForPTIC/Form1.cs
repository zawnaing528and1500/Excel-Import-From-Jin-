                ...
                if ((range.Cells[rCnt + 3, 3] as Excel.Range).Value != null)
                {
                    ...
                    if (Info.Count() != 0)
                    {
                        ...
                        try
                        {
                            ...
                            if (Info[12] != null)
                            {
                                if (Info[12].ToString() == "F")
                                    employee.Gender = false;
                                else if (Info[12].ToString() == "M")
                                    employee.Gender = true;
                            }

                            //get Mariental Status
                            if (Info[13] != null)
                                employee.MaritalStatus = Convert.ToBoolean(Info[13].ToString());
                            //get Passport Number
                            if (Info[14] != null)
                            {
                            ...
                            // Get Criminal
                            if (Info[18] != null)
                                employee.Criminal = Convert.ToBoolean(Info[18].ToString());//Input is 0 or 1
                        }
                        #endregion
                        catch (Exception ex)
                        {
